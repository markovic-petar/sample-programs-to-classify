...
void matrix_print(double* mx, size_t mx_rows, size_t mx_cols)
{
    // NULL ptr check
    if (!mx) return;
...
mx_mul_error_t matrix_mul (
    double* dst, size_t dst_rows, size_t dst_cols,
    const double* src1, size_t src1_rows, size_t src1_cols,
    const double* src2, size_t src2_rows, size_t src2_cols
)
{
